...
const PHONE_DISPLAY = '8 (925) 140-48-05'
const PHONE_HREF = 'tel:+79251404805'
const EMAIL = '89251404805@mail.ru'

/** Положите сюда PNG со скрина (филимоновская игрушка); пока — запасной кадр как у hero */
const DECORATIVE_IMAGE = '/images/home/hero-bg.png'
...
function SocialIcon({
  ...
  return (
    <a
      ...
      aria-label={label}
      className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#4A4A4A] text-white transition-colors hover:bg-[#3d3d3d]"
    >
      {children}
    </a>
  )
...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-white">
      <section className="border-b border-[#E5DECF] pb-12 pt-8 sm:pb-16 sm:pt-10 lg:pb-20 lg:pt-12">
        <div className="container">
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-14 xl:gap-20">
            <div>
              <h1 className="mb-8 text-3xl font-bold leading-tight text-[#1F1F1F] sm:mb-10 sm:text-4xl lg:text-5xl">
                Контакты
              </h1>

              <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-8 lg:gap-12">
                <div>
                  <h2 className="mb-4 text-lg font-bold text-[#1F1F1F] sm:text-xl">Служба поддержки клиентов</h2>
                  <div className="flex flex-col gap-3">
                    <a
                      href={PHONE_HREF}
                      className="rounded-xl border border-[#C88C39] bg-[#FFF6E7] px-4 py-3 text-center text-base font-medium text-[#232326] transition-colors hover:border-[#3D8C13] sm:px-5 sm:text-lg"
                    >
                      {PHONE_DISPLAY}
                    </a>
                    <a
                ...
                <div>
                  <h2 className="mb-4 text-lg font-bold text-[#1F1F1F] sm:text-xl">Социальные сети и мессенджеры</h2>
                  <div className="flex flex-wrap gap-3">
                    <SocialIcon href="https://t.me/+79295385634" label="Telegram">
                    ...
                    <SocialIcon href="https://wa.me/79251404805" label="WhatsApp">
                      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              <div className="mt-10 sm:mt-12">
                <h2 className="mb-4 text-lg font-bold text-[#1F1F1F] sm:text-xl">Юр информация</h2>
                <div className="max-w-xl space-y-1 text-sm leading-relaxed text-[#232326]/75 sm:text-base">
                  {legalLines.map((line) => (
                    <p key={line}>{line}</p>
                  ))}
                </div>
            ...
            <div className="mx-auto flex w-full max-w-[min(100%,420px)] justify-center lg:mx-0 lg:max-w-none lg:justify-end">
              <div className="relative aspect-square w-full max-w-[380px] overflow-hidden rounded-full bg-[#3D8C13] shadow-lg sm:max-w-[440px] lg:max-w-[min(100%,480px)]">
                <Image
                  src={DECORATIVE_IMAGE}
                  alt="Символика бренда"
                  fill
